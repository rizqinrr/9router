---
description: Membuat dan memperbarui dokumentasi project � SYSTEM_MAP, API_MAP, CHANGELOG, README, cross-reference validation
mode: subagent
permission:
  edit: allow
  bash: deny
...
```
0. READ SYSTEM_MAP.md (cari di root project atau docs/) — pahami struktur project terkini
