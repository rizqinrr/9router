---
description: Menghasilkan kode production-ready berdasarkan implementation plan � mengikuti existing pattern, backward compatible
mode: subagent
permission:
  edit: allow
  bash: allow
...
```
0. READ SYSTEM_MAP.md (cari di root project atau docs/) — pahami di mana file target dan template berada
