---
description: Analisis project tanpa mengubah kode � membaca struktur, framework, route, dependency, dan business flow
mode: subagent
permission:
  edit: deny
  bash: deny
...
```
0. READ SYSTEM_MAP.md (cari di root project atau docs/) — pahami struktur project sebelum traversal
